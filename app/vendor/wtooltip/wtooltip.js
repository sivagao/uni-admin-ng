...
(function($) { //jQuery.noConflict()compliant
    ...
    $.fn.wTooltip = function(o, callback) {
        ...
        //private settings
        var title, timeout, timeout2, iId, over = {}, firstMove = true,
            hovered = false,
            maxed = false,
            tooltip = document.createElement('div'),
            ie6 = (typeof document.body.style.maxWidth == "undefined") ? true : false,
            talk = (typeof $.talk == "function" && typeof $.listen == "function") ? true : false;
            ...
            $(this).mousemove(function(e) {
                ...
                if (o.follow || firstMove) {
                    var scrollY = $(window).scrollTop(),
                        ...
                        top = e.clientY + scrollY + o.offsetY,
                        left = e.clientX + scrollX + o.offsetX,
                        outerH = $(o.appendTip).outerHeight(),
                        innerH = $(o.appendTip).innerHeight(),
                        maxLeft = $(window).width() + scrollX - $(tooltip).outerWidth(),
                        maxTop = $(window).height() + scrollY - $(tooltip).outerHeight();
